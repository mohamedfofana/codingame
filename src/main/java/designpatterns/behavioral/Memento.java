...
//    }
//
//    public void execute(MMCommand c) {
...
//                    return;
//                }
//                if (moveMMCommand == null) {
//                    moveMMCommand = new MoveCommand(editor);
...
//                if (e.getButton() != MouseEvent.BUTTON1 || moveMMCommand == null) {
//                    return;
//                }
//                moveCommand.stop(e.getX(), e.getY());
//                editor.execute(moveCommand);
//                this.moveMMCommand = null;
//                repaint();
//            }
//        };
...
//        MMCommand command;
//        Memento memento;
//        Pair(MMCommand c, Memento m) {
//            command = c;
//            memento = m;
//        }
//
//        private MMCommand getCommand() {
//            return command;
//        }
//
...
//    }
//
//    public void push(MMCommand c, Memento m) {
...
//
//
//class ColorMMCommand implements MMCommand {
//    private Editor editor;
//    private Color color;
//
...
//}
//
//class MoveMMCommand implements MMCommand {
//    private Editor editor;
